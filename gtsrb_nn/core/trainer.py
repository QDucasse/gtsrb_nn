...
from gtsrb_nn.networks import LeNet, MLPNet
...
class Trainer(object):
    ...
    def load_train_test(self):
        ...
        self.train_loader = torch.utils.data.DataLoader(
                ...
                batch_size=self.batch_size_train, shuffle=True, num_workers=4)
        ...
        self.test_loader = torch.utils.data.DataLoader(
                ...
                batch_size=self.batch_size_test, shuffle=True, num_workers=4)
